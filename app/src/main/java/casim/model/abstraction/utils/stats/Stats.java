...
/**
 * An interface used to describe stats about an {@link casim.model.abstraction.Automaton}.
 * 
 *  @param <T> the type of the finite states of the {@link casim.model.abstraction.Automaton}'s {@link casim.model.abstraction.cell.Cell}.
 */
